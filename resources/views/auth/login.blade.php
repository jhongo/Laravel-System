<x-layouts.app title="Register" >
    <h1 class="my-4 font-serif text-3xl text-center text-sky-600 dark:text-sky-500" >Login</h1>
        ...
        {{-- <h2 class="my-4 font-serif text-3xl text-center text-sky-600 dark:text-sky-500" >Create new POST</h2> --}}
        ...
        <form class="max-w-xl px-8 py-4 mx-auto bg-white rounded shadow dark:bg-slate-800" action="{{ route('login') }}" method="POST" >
            ...
            <div  class="space-y-4">
                ...
                <label class="flex items-center">
                    ...
                    dark:text-slate-400 focus:ring focus:ring-slate-300 dark:focus:ring-slate-800 focus:ring-opacity-50
                    dark:focus:border-slate-700 focus:border-slate-300 dark:bg-slate-800 dark:border-slate-900
